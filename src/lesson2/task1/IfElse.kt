...
fun ageDescription(age: Int): String {
    return if (age % 10 == 1 && (age > 20 || age == 1) && age != 111) {
        "$age год"
    } else if (age == (2) || age == (3) || age == (4) || (age > 20 && (age % 10 == (2))) || (age > 20 && (age % 10 == (3))) || (age > 20 && (age % 10 == (4)))) {
        "$age года"
    } else "$age лет"
}
...
fun timeForHalfWay(
    ...
    return when {
        distance <= s1 -> distance / v1
        distance <= s2 -> t1 + (distance - s1) / v2
        else -> t1 + t2 + (distance - s2) / v3
    }
}
