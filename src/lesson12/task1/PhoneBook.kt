...
class PhoneBook {
    ...
    fun addPhone(name: String, phone: String): Boolean {
        if (phoneBook.containsKey(name) && !phoneBook.values.any { phone in it }) {
    ...
    override fun equals(other: Any?): Boolean {
        if (other is PhoneBook && phoneBook == other.phoneBook) return true
        return false
    }
}